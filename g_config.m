classdef g_config
    ...
    properties(Constant)
        ...
        TAGS = [ tag('UD', 'undefined', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...
                 tag('TT', 'thigmotaxis', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 1, [], g_config.CLASS_WEIGHT_MAJOR), ...
                 tag('IC', 'incursion', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 2, [], g_config.CLASS_WEIGHT_MAJOR), ...
                 tag('SS', 'scanning-surroundings', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 7, [], g_config.CLASS_WEIGHT_MAJOR), ...                 
                 tag('SC', 'scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3, [], g_config.CLASS_WEIGHT_MAJOR), ...
                 tag('FS', 'focused search', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 4, [], g_config.CLASS_WEIGHT_MINOR), ...                                  
                 tag('SO', 'self orienting', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 6, [], g_config.CLASS_WEIGHT_MINOR), ...
                 tag('CR', 'chaining response', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 5, [], g_config.CLASS_WEIGHT_MINOR), ...
                 tag('ST', 'target scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 8, [], g_config.CLASS_WEIGHT_MINOR), ...
                 tag('TS', 'target sweep', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3), ...             
                 tag('DF', 'direct finding', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...
                 tag('AT', 'approaching_target', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...                              
