classdef g_config
    ...
    properties(Constant)
        ...
        CLASS_WEIGHT_MINOR = 1;
        CLASS_WEIGHT_MAJOR = 8;
        
        % default tags               
        TAGS = [ tag('UD', 'undefined', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...
                 tag('TT', 'thigmotaxis', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 1, [], g_config.CLASS_WEIGHT_MINOR), ...
                 tag('IC', 'incursion', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 2, [], g_config.CLASS_WEIGHT_MINOR), ...
                 tag('SS', 'scanning-surroundings', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 7, [], g_config.CLASS_WEIGHT_MINOR), ...                 
                 tag('SC', 'scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3, [], g_config.CLASS_WEIGHT_MINOR), ...
                 tag('FS', 'focused search', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 4, [], g_config.CLASS_WEIGHT_MAJOR), ...                                  
                 tag('SO', 'self orienting', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 6, [], g_config.CLASS_WEIGHT_MAJOR), ...
                 tag('CR', 'chaining response', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 5, [], g_config.CLASS_WEIGHT_MAJOR), ...
                 tag('ST', 'target scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 8, [], g_config.CLASS_WEIGHT_MAJOR), ...
                 tag('TS', 'target sweep', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3), ...             
                 tag('DF', 'direct finding', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...
                 tag('CI', 'circling', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 8), ...                                   
...
%                  tag('IC', 'incursion', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 2, g_config.CLASS_WEIGHT_MINOR), ...
%                  tag('SS', 'scanning-surroundings', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 7, g_config.CLASS_WEIGHT_MINOR), ...                 
%                  tag('SC', 'scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3, g_config.CLASS_WEIGHT_MAJOR), ...
%                  tag('FS', 'focused search', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 4, g_config.CLASS_WEIGHT_MAJOR), ...                                  
%                  tag('SO', 'self orienting', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 6, g_config.CLASS_WEIGHT_MAJOR), ...
%                  tag('CR', 'chaining response', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 5, g_config.CLASS_WEIGHT_MAJOR), ...
%                  tag('ST', 'target scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 8, g_config.CLASS_WEIGHT_MAJOR), ...
...
%         ];   
        ...
        REDUCED_BEHAVIOURAL_CLASSES = [ ...
            tag.combine_tags( [g_config.TAGS(tag.tag_position(g_config.TAGS, 'TT')), g_config.TAGS(tag.tag_position(g_config.TAGS, 'IC'))]), ...
            g_config.TAGS(tag.tag_position(g_config.TAGS, 'FS')), ...
            g_config.TAGS(tag.tag_position(g_config.TAGS, 'SC')), ...
            g_config.TAGS(tag.tag_position(g_config.TAGS, 'SS')), ...
            g_config.TAGS(tag.tag_position(g_config.TAGS, 'CR')), ...
            tag.combine_tags( [g_config.TAGS(tag.tag_position(g_config.TAGS, 'SO')), g_config.TAGS(tag.tag_position(g_config.TAGS, 'ST'))])  ...                          
        ];
