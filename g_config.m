classdef g_config
    ...
    properties(Constant)
        ...
        TAGS = [ tag('UD', 'undefined', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...
                 ...
                 tag('SS', 'scanning-surroundings', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 7), ...                 
                 tag('SC', 'scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3), ...
                 tag('FS', 'focused search', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 4), ...                                  
                 tag('SO', 'self orienting', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 6), ...
                 tag('CR', 'chaining response', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 5), ...
                 tag('ST', 'target scanning', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 8), ...
                 tag('TS', 'target sweep', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 3), ...             
...
%         ];   
        ...
        SEGMENTS_TAGS250_PATH = '/home/tiago/neuroscience/rat_navigation/trajectories/segment_labels_250c.csv';
        
        SEGMENTS_TAGS250_70_PATH = '/home/tiago/neuroscience/rat_navigation/trajectories/segment_labels_250_70.csv';
