classdef g_config
    ...
    properties(Constant)
        ...
        TAGS = [ tag('UD', 'undefined', g_config.TAG_TYPE_BEHAVIOUR_CLASS), ...
                 ...
                 tag('CI', 'closed-incursion', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 8), ...                  
                 tag('SS', 'scanning-surroundings', g_config.TAG_TYPE_BEHAVIOUR_CLASS, 9), ...                 
...
%         ];   
        ...
        REDUCED_BEHAVIOURAL_CLASSES = [ ...
            tag.combine_tags( [g_config.TAGS(tag.tag_position(g_config.TAGS, 'TT')), g_config.TAGS(tag.tag_position(g_config.TAGS, 'IC'))]), ...
            g_config.TAGS(tag.tag_position(g_config.TAGS, 'TS')), ...
            g_config.TAGS(tag.tag_position(g_config.TAGS, 'CR')), ...
            tag.combine_tags( [g_config.TAGS(tag.tag_position(g_config.TAGS, 'ST')), g_config.TAGS(tag.tag_position(g_config.TAGS, 'SC')), g_config.TAGS(tag.tag_position(g_config.TAGS, 'SO'))])  ...                          
        ];
        ...
        DEFAULT_FEATURE_SET = [features.MEDIAN_RADIUS, features.IQR_RADIUS, features.FOCUS, features.CV_INNER_RADIUS, ...
