classdef config_mwm < base_config
    ...
    methods    
        function inst = config_mwm()
            ...
            % values are: file that stores the tags, default number of clusters, segment length, overlap% (SEGMENTATION_CONSTANT_LENGTH, 2 are used for internal computations) 
            inst.TAGS_CONFIG = { ... 
